...
#define MyAppVersion "2.7.3-SP2"
; Windows file metadata (VersionInfoVersion) must be strictly numeric — the
; display version above may carry a stability suffix (e.g. 2.7.2-SP1), which
; release.py --set-version mirrors into this numeric define automatically.
#define MyAppVersionNumeric "2.7.3"
