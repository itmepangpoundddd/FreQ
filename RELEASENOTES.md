...
on air with confidence — a NINE-stage native mic filter chain with real
OBS-style parameter sliders, audio that survives device format changes
mid-broadcast, pre-show readiness tools, and a much friendlier queue. Plus
every fix accumulated in 0925.1/0925.2.
