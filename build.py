...
def build(debug=False):
    ...
    for stem in ("native_audio_meter", "native_audio_output", "native_audio_render", "native_audio_decode", "native_audio_capture", "native_audio_stream", "native_aircheck", "native_stream"):
